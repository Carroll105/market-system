...
void work() {
	...
	fprintf(fp,"1.%s  %f  %f\n2.%s  %f  %f\n3.%s  %f  %f\n4.%s  %f  %f\n5.%s  %f  %f\n ",b[0].type,g[0].number,g[0].money,b[1].type,g[1].number,g[1].money,b[2].type,g[2].number,g[2].money,b[3].type,g[3].number,g[3].money,b[4].type,g[4].number,g[4].money);
	fclose(fp);
	FILE *kp = fopen("F:\\VIP1.txt", "w");
	for (i2 = 0; i2<nnp; i2++)
	{
